...
export const WHITELIST_CONTRACT_ADDRESS = '0xe2ba9bcac21eb68f86938d166802283ac57c7530';
export const USDT_CONTRACT_ADDRESS = '0x55d398326f99059ff775485246999027b3197955';

// ePound contracts
export const EPOUND_WHITELIST_CONTRACT_ADDRESS = '0x114874b13f6172fcd7b0c3b308c3a006876e8333';
export const EPOUND_CONTRACT_ADDRESS = '0x42A53b1fD6Bd9279C6e5D88D53361BB524591472';
...
export type CurrencyType = keyof typeof SUPPORTED_CURRENCIES;

// Whitelist Contract ABI
export const WHITELIST_ABI = [
  {
    "inputs": [
      {"internalType": "address payable", "name": "_platformWallet", "type": "address"},
...
// ePound Whitelist Contract ABI
export const EPOUND_WHITELIST_ABI = [
  {
...
// ePound Token ABI (ERC20)
export const EPOUND_ABI = [
  {
    "inputs": [],
    "stateMutability": "nonpayable",
    "type": "constructor"
